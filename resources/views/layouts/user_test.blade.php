...
@section('js')
  <!-- Personalizado -->
  <script src="Views/js/home-admin.js"></script>
@stop
@section('content')
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row m-2">
            <div class="col-lg-2 my-auto"><img src="Views/img/usuarios/user-default.jpg" class="img-fluid img-circle" alt="User Image"></div>
            <div class="col-lg-5 my-auto">
              <h4>Bienvenido al Sistema de administración para Copropietarios de Forzzeti señor@ FULANITO</h4>
            </div>
            <div class="col-lg-5 my-auto">
              <h6><b>Su saldo es: </b>$150.000</h6>
              <h6><b>Su ultima factura es por : </b>$250000. Con descuento antes de 19/07/08</h6>
              <h6><b>Su ultimo pago es por: </b>$100.000. Registrado el dia 19/06/08</h6>
            </div>
          </div>
        </div>
        <!-- /.container-fluid -->
      ...
      <div class="col-lg-3 col-6 col-xs-12">
        ...
        <div class="small-box bg-secondary2">
          ...
          <a href="#" class="small-box-footer">Enviar mensaje  <i class="fa fa-arrow-circle-right"></i></a>
        </div>
      </div>
      </div>
    ...
    <div class="row m-3">
      <!-- Small boxes (Stat box) -->
      <div class="col-6 col-xs-12 d-none opcionOculta">
        <!-- small box -->
        <div class="small-box bg-primary">
          <div class="inner">
            <h3> Clasificados </h3>
